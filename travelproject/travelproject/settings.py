...
#This package automatically detects the database URL from the DATABASE_URL environment variable.
...
SECRET_KEY = 'django-insecure-y)xkz^+fbv%xttk16ou*&g3hk&uslcfl883co3tm2@wbx^q&**'
...
# install djangorestframework and the travels app
INSTALLED_APPS = [
...
# Since we're not utilizing a .env file, we'll manually define the environmental variable in our terminal. Just remember that you'll need to define the variable again each time you open a new terminal.
#
# Here's an example of how to define the environmental variable for our bit.io Postgres database:
#
...
# echo $DATABASE_URL
# OR use %variable%
# This will display the value of the DATABASE_URL environmental variable.